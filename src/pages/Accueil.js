...
Nous vous proposons une large gamme de <Link to="/produits" >produits</Link> dont beaucoup sont des créations maisons.
        ...
        <section>
          <span className="subtitle">Retrouvez nous à <strong>Orthez</strong>, au 3 rue du Général Foy.</span>
        ...
        <span className="subtitle">Vous pouvez aussi nous contacter...</span>
        <ul>
          <li>
        ...
        <span className="subtitle">...Ou nous retrouver sur les réseaux sociaux !</span>
        <ul>
          <li>
